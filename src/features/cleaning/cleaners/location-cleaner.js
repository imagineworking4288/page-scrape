 ...
 * Location Cleaner
 *
 * Removes phone numbers and email addresses from location strings.
 * Returns cleaned location or null if empty after cleaning.
 */
...
class LocationCleaner {
  /**
   * Clean a location string by removing phone numbers and emails
   * @param {string} value - Input location string
...
module.exports = { LocationCleaner };
